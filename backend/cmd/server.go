...
func registerRoutes(app *fiber.App, container *Container) {
	...
	container.Currency.RegisterPublicRoutes(public)
	container.I18n.RegisterPublicRoutes(public)
	...
	container.MultiStore.RegisterPublicRoutes(public)
	...
	container.Currency.RegisterRoutes(protected)
	container.I18n.RegisterRoutes(protected)
	...
	container.Returns.RegisterRoutes(protected)
	container.Webhook.RegisterRoutes(protected)
	...
	container.Blog.RegisterRoutes(protected)
	container.Collection.RegisterRoutes(protected)
	container.ABTest.RegisterRoutes(protected)
